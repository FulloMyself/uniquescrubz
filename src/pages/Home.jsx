...
export default function Home({ cartItems, setCartItems }) {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl font-bold text-center text-gray-800 mb-4 mt-12">All Products</h1>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-8">
        ...
        <select value={selectedTag} onChange={(e) => setSelectedTag(e.target.value)} className="border border-gray-300 rounded px-4 py-2">
